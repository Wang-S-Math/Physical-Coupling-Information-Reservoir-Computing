...
# 3. 第一阶段：参数辨识 (仅支持已知结构)
# ==========================================
def stage_1_predict_weights_with_structure(time_series, dt=0.05, train_len=15000, sync_len=1000,
                                           res_size=500, lambda_ridge=1e-3, lambda_net=1e-7,
                                           coupling_dims=[1, 0, 0], coupling_strength=0.05,  # Rössler 默认耦合强度
    ...
    for i in range(N_nodes):
        # 保持 Rössler 适合的 input_scale=0.05
        ...
        # === 核心逻辑：直接使用 known_structure 获取邻居 ===
...
def stage_2_direct_prediction(time_series, W_pred_real, trained_reservoirs, dt=0.01,
                              ...
                              coupling_dims=[1, 0, 0], coupling_strength=0.05):
    print("\n" + "=" * 60)
...
if __name__ == "__main__":
    ...
    print(f"System=lsl, topology=known, M={M}")
